        ...
        <div class="space-y-1.5">
          ...
          <div class="flex justify-end pr-2">
            <span class="text-[12.5px] font-medium text-gray-500">
              Forgot Password ? <button type="button" @click="showChangePasswordModal = true" class="text-red-500 hover:text-red-600 transition-colors font-semibold">Change Password</button>
            </span>
          </div>
        </div>
